...
def main(output_dir=None):
    ...
    # 读取数据
    print("读取开挖线数据...")
    excavation_points = read_xyz_file(os.path.join(output_dir, '开挖线_xyz.txt'))
    print(f"  开挖线点数: {len(excavation_points)}")
    
    print("读取超挖线数据...")
    overbreak_points = read_xyz_file(os.path.join(output_dir, '超挖线_xyz.txt'))
    print(f"  超挖线点数: {len(overbreak_points)}")
    
    print("读取中心线数据...")
    centerline_points = read_centerline_file(os.path.join(output_dir, '中心线位置.txt'))
